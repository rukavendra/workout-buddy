...
const WorkoutDetails = ({workout}) => {
  ...
  const handleDelete= async()=>{
    ...
    const response = await fetch(`https://workout-app-xuea.onrender.com/workouts/${workout._id}`,{ method:"DELETE",headers: {'Authorization': `Bearer ${user.token}`}})
  ...
  //   const response= await fetch('https://workout-app-xuea.onrender.com/workouts'+workout._id, { method: 'PATCH', headers: {'Authorization': `Bearer ${user.token}`}})
  //   const json = await response.json()
  //   if(response.ok){
